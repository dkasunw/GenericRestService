...
package org.wso2.automation.peoplesample;

import org.apache.cxf.rs.security.cors.CorsHeaderConstants;
import org.wso2.automation.peoplesample.bean.Person;
...
*/
    ...
    @Path("/InnerPath")
    @POST
    public Response addPersonXml(@Context final UriInfo uriInfo) {
        peopleService.addPerson("dharshanaw@wso2.com223", "sdds", "ssss");
        return Response.created(uriInfo.getRequestUriBuilder().path("dharshanaw@wso2.com223").build()).build();
       // return Response.noContent().build();
    }
